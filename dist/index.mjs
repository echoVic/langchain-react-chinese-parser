...
var BaseChineseReActParser = class extends BaseOutputParser {
  constructor(options = {}) {
    super();
    this.options = {
      debug: false,
...
// src/factory.ts
import { BaseOutputParser as BaseOutputParser2 } from "@langchain/core/output_parsers";
...
var UniversalChineseReActParser = class extends BaseOutputParser2 {
  constructor(options = {}) {
    super();
...
export {
  ...
  createERNIEParser,
  createQwenParser,
  createChineseReActParser as default
};
